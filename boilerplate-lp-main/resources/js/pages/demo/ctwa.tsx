...
function flashDeadline(): number {
    ...
    try {
        start = Number(localStorage.getItem('fb_flash_start') || 0);
    } catch {
        /* storage disabled */
    }
...
const KEYFRAMES = `
  body:has(.fullbright-page) { margin: 0; background: #fff; color: #151515; }
  @layer base { body:has(.fullbright-page) :where(h1, h2, h3, h4, h5, h6, p, span, div, li, a, button, input, select, textarea, ul, ol, strong, b, em, i, label) { font-family: 'Nunito', system-ui, sans-serif; } }
  @layer base { body:has(.fullbright-page) a { color: #D70808; } body:has(.fullbright-page) a:hover { color: #b30606; } }
    ...
    return (
        <>
            <Head title="Kelas TOEFL Skor 500+ untuk Submission Beasiswa dan Kerja">
                <meta
                    name="description"
                    content="Persiapkan TOEFL 500+ dengan metode belajar terstruktur dari Full Bright Indonesia. Pilih belajar mandiri atau dibimbing tutor."
                />
            </Head>
            <style>{KEYFRAMES}</style>

            <div className="fullbright-page [min-height:100vh] [font-family:Nunito,system-ui,sans-serif] [color:#151515] [background:#fff]">
